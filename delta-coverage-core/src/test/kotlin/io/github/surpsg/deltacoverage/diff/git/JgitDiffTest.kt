...
class JgitDiffTest {
    ...
    @Test
    fun `JgitDiff should throw when git is not initialized`() {
    ...
    @Test
    fun `jgit diff should encode file path with special symbols`() {
    ...
    @Test
    fun `jgit diff should throw if branch name is unknown`() {
        // setup
    ...
    @Test
    fun `jgit diff should merge changes from target branch`() {
        // setup
        val master = "master"
    ...
    @Test
    fun `jgit diff should return diff ignoring all whitespaces`() {
        // setup
        val master = "master"
        val testBranch = "current_branch"
