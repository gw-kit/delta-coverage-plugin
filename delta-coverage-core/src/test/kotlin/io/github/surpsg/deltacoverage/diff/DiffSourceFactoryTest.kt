...
class DiffSourceFactoryTest {

    @Test
    fun `buildDiffSource should return file diff source`() {
        // setup
    ...
    @Test
    fun `buildDiffSource should return url diff source`() {
        // setup
    ...
    @Test
    fun `buildDiffSource should return git diff source`() {
        // setup
    ...
    @Test
    fun `buildDiffSource should throw when no source specified`() {
        // setup
