...
[![Build](https://github.com/gw-kit/delta-coverage-plugin/actions/workflows/base-ci.yml/badge.svg?branch=main)](https://github.com/gw-kit/delta-coverage-plugin/actions/workflows/base-ci.yml)
